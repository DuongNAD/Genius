...
async def test_rate_limiter_lock_bypass():
    ...
    assert task_a1_result[0] is True, "Task A1 should have consumed the token after lock release"
    assert task_a2_result[0] is False, "Task A2 should get False because Task A1 consumed the last token"
