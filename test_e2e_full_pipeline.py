...
@patch("httpx.AsyncClient.get", new_callable=MagicMock)
@patch("orchestrator.run_subprocess", new_callable=MagicMock)
async def test_e2e_codex_self_healing_success(
    mock_run_subproc, mock_get, mock_post, temp_workspace
):
...
@patch("httpx.AsyncClient.get", new_callable=MagicMock)
@patch("orchestrator.run_subprocess", new_callable=MagicMock)
async def test_e2e_codex_self_healing_failure(
    mock_run_subproc, mock_get, mock_post, temp_workspace
):
...
@patch("httpx.AsyncClient.get", new_callable=MagicMock)
@patch("orchestrator.run_subprocess", new_callable=MagicMock)
async def test_e2e_tester_self_healing_success(
    mock_run_subproc, mock_get, mock_post, temp_workspace
):
...
@patch("httpx.AsyncClient.get", new_callable=MagicMock)
@patch("orchestrator.run_subprocess", new_callable=MagicMock)
async def test_e2e_tester_self_healing_failure(
    mock_run_subproc, mock_get, mock_post, temp_workspace
):
...
@patch("httpx.AsyncClient.get", new_callable=MagicMock)
@patch("orchestrator.run_subprocess", new_callable=MagicMock)
async def test_e2e_pythonpath_setting(
    mock_run_subproc, mock_get, mock_post, temp_workspace
):
    ...
    for env in subproc_envs:
        ...
        project_src_dir_str = str(
            temp_workspace / "projects" / "write_hello_world" / "src"
        )
