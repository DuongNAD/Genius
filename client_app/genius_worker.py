...
def main():
    ...
    parser.add_argument("--roles", default="grok", help="Comma-separated roles this worker supports")
    parser.add_argument("--worker-id", default=None, help="Unique worker ID (generates UUID if not specified)")
