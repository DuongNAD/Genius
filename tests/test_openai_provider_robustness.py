...
async def test_openai_provider_long_output_stream():
    ...
    for i in range(50000):
        lines.append(json.dumps({"event": "agent_message", "item": {"text": f"token_{i} "}}))
    lines.append(json.dumps({"event": "turn.completed", "turn.completed": {"usage": {"input_tokens": 100, "output_tokens": 50000}}}))
